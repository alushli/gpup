...
public class WorkerUserListRefresher extends TimerTask {
    ...
    public WorkerUserListRefresher(BooleanProperty shouldUpdate, Consumer<List<UserDTO>> usersListConsumer) {
