...
public class UserTableController extends components.workerMainControllers.workerControllers implements Closeable{
    private Timer timer;
    ...
    public void startListRefresher() {
        listRefresher = new WorkerUserListRefresher(
                autoUpdate,
