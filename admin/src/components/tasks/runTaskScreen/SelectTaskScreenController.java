...
public class SelectTaskScreenController extends components.mainControllers.Controllers {
    ...
    void clickNext(ActionEvent event) {
        if(this.task_CB.getValue().equals("Simulation Task")){
            ...
            this.mainController.updateCompilerTaskProperties(this.source_compiler_label.getText(), this.compiled_compiler_label.getText(), SimulationEntryPointAdmin.FROM_SCRATCH);
        }
    }
